...
<img src="./二叉树.assets/二叉树.png" alt="二叉树" style="zoom:20%;" />

遍历方式：

* 前序遍历：**根 左子树 右子树** 

  ![前序遍历](./二叉树.assets/前序遍历.png)
  ...
  ![前序遍历递归展开图](./二叉树.assets/前序遍历递归展开图.png)

* 中序遍历：左子树 根 右子树

  ![中序遍历](./二叉树.assets/中序遍历.png)
  ...
  ![中序遍历递归展开图](./二叉树.assets/中序遍历递归展开图.png)
